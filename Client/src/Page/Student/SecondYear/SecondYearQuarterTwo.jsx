...
function SecondYearQuarterTwo() {
  ...
  useEffect(() => {
    setLoading(true);
    const url = "/api/y2-quarter2/videos";
    videoService
      .fetchLessons(url)
      .then((videoData) => {
    ...
    videoService
      ...
      .then((data) => {
        const hasPaid = data.some(
          (payment) => payment.quarter === "Q5" && payment.status === 1
        );
                ...
                <>
                  <div className="w-full text-center mb-4">
                    ...
                    <p className="text-gray-400">
                      ...
                      {currentLesson.quarter || "2"} | Week: {activeWeek + 1}
                    </p>
                  </div>
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center p-8 bg-red-700 rounded-lg shadow-xl">
            ...
            <p className="text-gray-200 text-lg">
              Complete your payment for Quarter 2 to unlock this content.
            </p>
          </div>
        </div>
      )}
...
export default SecondYearQuarterTwo;
