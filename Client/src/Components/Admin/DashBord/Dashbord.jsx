          ...
          <div class="container-fluid-2">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-30px pt-30px pb-100px">
              ...
              <div class="lg:col-start-4 lg:col-span-9">
                <div class="p-10px md:px-10 md:py-50px mb-30px bg-whiteColor-dark  border border-whitegrey shadow-accordion dark:shadow-accordion-dark rounded-5 ">
                  <div class="mb-6 pb-5 border-b-2 border-whitegrey dark:border-whitegrey-dark">
                    <h2 class="text-2xl font-bold   dark: -dark">Dashboard</h2>
                  </div>
                  <div class="counter grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-30px gap-y-5 pb-5">
                    <div class="p-5 md:px-10 md:py-50px   dark:bg-whiteColor-dark rounded-lg2 shadow-accordion-dark">
                      <div class="flex gap-4">
                        <div>
                          <img src={Q1} alt="" />
                        </div>
                        <div>
                          <p class="text-size-34 leading-[1.1]   font-bold font-hind dark: -dark">
                            <span data-countup-number="900"> 900</span>
                            <span>+</span>
                          </p>
                          <p class="  font-medium leading-[18px] dark: -dark">
                            Enrolled Courses
                          </p>
                        </div>
                      </div>
