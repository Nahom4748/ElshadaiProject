...
const Year1Q2 = () => {
  ...
  const fetchVideos = () => {
    setLoading(true);
    axios
      .get(`${BASE_URL}/api/quarter2/videos`)
      .then((response) => {
  ...
  const handleVideoUpdate = () => {
    ...
    axios
      .put(`${BASE_URL}/api/quarter2/videos/${selectedVideo.id}`, selectedVideo)
      .then(() => {
        fetchVideos();
        closeVideoModal();
      })
  ...
  const handleDocUpdate = () => {
    ...
    axios
      .put(
        `${BASE_URL}/api/quarter2/videos/${selectedVideo.id}/document`,
        formData
      )
      .then(() => {
        fetchVideos();
