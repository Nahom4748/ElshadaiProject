...
const Year1Q3 = () => {
  ...
  const handleVideoUpdate = () => {
    ...
    axios
      .put(
        `http://localhost:5001/api/quarter3/videos/${selectedVideo.id}`,
        selectedVideo
      )
      .then(() => {
        fetchVideos();
  ...
  const handleDocUpdate = () => {
    ...
    axios
      .put(
        `http://localhost:5001/api/quarter3/videos/${selectedVideo.id}/document`,
        formData
      )
      .then(() => {
        fetchVideos();
